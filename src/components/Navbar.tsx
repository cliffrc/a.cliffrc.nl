  ...
  return (
    <header className="relative z-[999] mt-16 sm:mt-10">
      ...
      <nav className="fixed left-1/2 top-[0.15rem] flex h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:py-0">
        <ul className="flex w-[22rem] flex-wrap items-center justify-center gap-x-2 gap-y-4 text-sm font-medium text-zinc-500/90 sm:w-[initial] sm:flex-nowrap sm:gap-5">
